...
//struct dos inimigos
        ...
        strcpy(nomes_inimigos[4].nome, "Penes");
        nomes_inimigos[4].vida = 15;
        nomes_inimigos[4].xp = 10;
        nomes_inimigos[4].dano = 0;
	...
	nomes_inimigos[14].codigo_inimigo = 14;
        ...
        strcpy(classes[3].skill[2], "Dardo Envenenado");
    ...
    while(continua == 1)
    {
        ...
        else
        {
            ...
            personagem_criado.vida = classes[classe_escolhida].atributo_de_vida * (personagem_criado.nivel) + 50;
            if(vida_atual > 0){
                personagem_criado.vida = vida_atual;
            }else{
                system("CLS");
                printf("Voce morreu");
                return 0;
